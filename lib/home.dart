...
class Home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget firstCategory = buildCategory(
        'Consultation',
        blue,
        'assets/Ellipse 85.png',
        'assets/007-stethoscope.png',
        56,
        38,
        24,
        56,
        ...
        11,
        8);
    Widget secondCategory = buildCategory(
        'Dental',
        violet,
        'assets/Ellipse 85.png',
        'assets/004-teeth.png',
        56,
        38,
        24,
        56,
        ...
        116,
        8);
    Widget thirdCategory = buildCategory(
        'Heart',
        orange,
        'assets/Ellipse 85.png',
        'assets/017-heart.png',
        56,
        38,
        24,
        56,
        ...
        209,
        8);
    Widget fourthCategory = buildCategory(
        'Hospitals',
        yellow,
        'assets/Ellipse 85.png',
        'assets/024-clinic.png',
        56,
        38,
        24,
        56,
        ...
        289,
        8);
    Widget fifthCategory = buildCategory(
        'Medicines',
        green,
        'assets/Ellipse 85.png',
        'assets/012-medicine.png',
        56,
        38,
        24,
        56,
        ...
        17,
        8);
    Widget sixthCategory = buildCategory(
        'Physician',
        lightblue,
        'assets/Ellipse 85.png',
        'assets/013-care-2.png',
        56,
        38,
        24,
        56,
        ...
        108,
        8);
    Widget seventhCategory = buildCategory(
        'Skin',
        pink,
        'assets/Ellipse 85.png',
        'assets/028-bandage.png',
        56,
        38,
        24,
        56,
        ...
        213,
        8);
    Widget eightCategory = buildCategory(
        'Surgeon',
        darkorange,
        'assets/Ellipse 85.png',
        'assets/005-syringe.png',
        56,
        38,
        24,
        56,
    ...
    Widget firstProfile = buildProfiles(
        'assets/Lbl_Photo.png',
        'assets/Group 3.png',
        ...
        greenBg,
        greenText);
    Widget secondProfile = buildProfiles(
        'assets/Lbl2_Photo.png',
        'assets/Group 3.png',
        'Dr. Shabil Chan',
        ...
        greenBg,
        greenText);
    Widget thirdProfile = buildProfiles(
        'assets/Lbl3_Photo.png',
        'assets/Group 3.png',
        'Dr. Mustakim',
        ...
        redBg,
        redText);
    Widget fourthProfile = buildProfiles(
        ...
        greenBg,
        greenText);
    Widget fifthProfile = buildProfiles(
          ...
          children: [
            Stack(
              children: [
                ...
                buildTopDocTxt(),
                buildViewAllTxt(),
                buildListView(firstProfile, secondProfile, thirdProfile,
                    fourthProfile, fifthProfile)
              ],
            ),
          ],
        ),
          ...
          children: [
            Stack(
              children: [
                ...
                buildViewAllTxt(),
                Expanded(
                    child: buildListView(firstProfile, secondProfile,
                        thirdProfile, fourthProfile, fifthProfile))
              ],
            ),
          ],
        ),
  ...
  Container buildListView(Widget firstProfile, Widget secondProfile,
      Widget thirdProfile, Widget fourthProfile, Widget fifthProfile) {
    return Container(
